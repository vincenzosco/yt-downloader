...
// 1. search
const s = await innertube('/search', CLIENT_WEB, { query: 'never gonna give you up' });
...
const p = await innertube('/player', CLIENT_ANDROID, { videoId: 'dQw4w9WgXcQ' });
...
// 3. playlist
const n = await innertube('/next', CLIENT_WEB, { playlistId: 'PLFgquLnL59alCl_2TQvOiD5Vgm1hCaGSI' });
...
try {
  await innertube('/player', CLIENT_ANDROID, { videoId: 'zzzzzzzzzzz' });
  parsePlayer(await innertube('/player', CLIENT_ANDROID, { videoId: 'zzzzzzzzzzz' }));
